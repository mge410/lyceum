...
class FeedbackForm(django.forms.Form):
    ...
    def save(self, file_list):
        ...
        data_user = feedback.models.FeedbackUserData(email=data['email'], feedback=feedback_data)
        ...
        if data['files'] is not None:
            for file in file_list:
                feedback_files = feedback.models.FeedbackFiles(files=file, feedback=feedback_data)
                feedback_files.save()
